...
class PinCodeWidgetOld extends StatefulWidget {
  const PinCodeWidgetOld({
    Key? key,
  ...
  final void Function(String pin, PinCodeWidgetOldState state) onFullPin;
  ...
  @override
  State<StatefulWidget> createState() => PinCodeWidgetOldState();
}

class PinCodeWidgetOldState<T extends PinCodeWidgetOld> extends State<T> {
